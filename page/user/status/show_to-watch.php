         ...
         <div class="sidebar col-auto col-md-3 min-vh-100 ">
            <div class="side-content d-flex flex-column align-items-center  ">
               ...
               <ul class="nav d-flex flex-column">
                  ...
                  <li><a href="show_to-watch.php" class="text-decoration-none text-warning  px-4 py-2"><i
                     class=" fa-regular fa-user"></i> <span class="d-none d-md-inline text-warning ">to watch</span></a>
                  </li>
               ...
               <table class="table table-hover text-center  ">
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td>
                           <a href="delete_to-watch.php?id=<?php echo $row["id"] ?>" class="link-dark"><i class="fa-solid fa-trash fs-5" style="color: #f00000;"></i></a>
                        </td>
                     </tr>
                     <?php
                        }
