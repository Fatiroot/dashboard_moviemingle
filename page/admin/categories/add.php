...
<html lang="en">
   ...
   <body class="bg-black">
      ...
      <section class="container">
         ...
         <div class="col-lg-11">
            <h1 class="title fs-5 text-center">Add New categorie</h1>
            <div class="container">
               <div class="text-center mb-4">
                  <p class=" text-white">Complete the form below to add a new categories</p>
               </div>
               ...
               <form action="" method="post" style="width:50vw; min-width:300px;">
                     <div class="row mb-3">
                        <div class="col">
                           ...
                           <input type="text" class="form-control" name="genre" placeholder="titre">
                        </div>
                        <div class="col">
